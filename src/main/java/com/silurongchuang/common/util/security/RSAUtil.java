package com.silurongchuang.common.util.security;
...
/**
 * RSA加密和解密工具
 * 工具来自: https://www.cnblogs.com/jun1019/p/9345879.html
 * @Author: Ms
...
public class RSAUtil {
     ...
     * 存放密钥键值对
     */
    private static Map<String, String> PairMap;
    ...
    static {
        ...
        try {
            ...
            System.out.println("RSA密钥创建完成");
        } catch (NoSuchAlgorithmException e) {
            System.out.println("RSA密钥生成失败");
            e.printStackTrace();
     ...
     * @return
     */
    public static KeyPair toGetKey(){
        return keyPair;
    }
    ...
    public static String privateKeyStr(){
        return PairMap.get("privateKeyString");
    }
    ...
    public static String publicKeyStr(){
        return PairMap.get("publicKeyString");
    }
     ...
     * @throws Exception
     */
    public static byte[] decryptByPriKey(byte[] data, byte[] priKey) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(priKey);
        KeyFactory keyFactory = KeyFactory.getInstance(RSA_KEY_ALGORITHM);
        PrivateKey privateKey = keyFactory.generatePrivate(pkcs8KeySpec);
        Cipher cipher = Cipher.getInstance(keyFactory.getAlgorithm());
     ...
     * @throws Exception
     */
    public static String decryptByPriKey(String data, String privateKey) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeySpecException, BadPaddingException, InvalidKeyException {
        byte[] priKey = RSAUtil.decodeBase64(privateKey);
